...
problema = mlrose_hiive.DiscreteOpt(length=12, fitness_fn=fitness,
                              maximize = False, max_val = 10)
melhor_solucao, melhor_custo, _ = mlrose_hiive.hill_climb(problem=problema, random_state=1)
print(melhor_custo)

melhor_solucao, melhor_custo, _ = mlrose_hiive.simulated_annealing(problema,
                                                          schedule=mlrose_hiive.GeomDecay(init_temp=10000), # ATUALIZAÇÃO FEV-2024
                                                          random_state=1)
print(melhor_custo)
